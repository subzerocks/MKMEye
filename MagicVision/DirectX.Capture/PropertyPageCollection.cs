...
namespace DirectX.Capture
{
    ...
    public class PropertyPageCollection : CollectionBase, IDisposable
    {
        ...
        public PropertyPage this[int index] => (PropertyPage) InnerList[index];
            ...
            SourceCollection videoSources, SourceCollection audioSources)
        {
            ...
            var num = 1;
            for (var c = 0; c < videoSources.Count; c++)
            {
            ...
            num = 1;
            for (var c = 0; c < audioSources.Count; c++)
            {
        ...
        protected bool addIfSupported(object o, string name)
        {
            ...
            try
            {
                ...
                {
                    var hr = specifyPropertyPages.GetPages(out cauuid);
