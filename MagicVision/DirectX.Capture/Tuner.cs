    ...
    public class Tuner : IDisposable
    {
        ...
        public int Channel
        {
            get
            {
                int channel;
                int v, a;
                var hr = tvTuner.get_Channel(out channel, out v, out a);
            ...
            set
            {
                var hr = tvTuner.put_Channel(value, AMTunerSubChannel.Default, AMTunerSubChannel.Default);
                if (hr != 0) Marshal.ThrowExceptionForHR(hr);
            }
        }
        ...
        public TunerInputType InputType
        {
            get
            {
                ...
                var hr = tvTuner.get_InputType(0, out t);
                if (hr != 0) Marshal.ThrowExceptionForHR(hr);
                return(TunerInputType) t;
            }
            set
            {
                var t = (DShowNET.TunerInputType) value;
                var hr = tvTuner.put_InputType(0, t);
                if (hr != 0) Marshal.ThrowExceptionForHR(hr);
            }
        }
        ...
        public bool SignalPresent
        {
            get
            {
                ...
                var hr = tvTuner.SignalPresent(out sig);
                if (hr != 0) Marshal.ThrowExceptionForHR(hr);
