...
namespace DirectX.Capture
{
    ...
    {
        /// <summary>
        ///     Granularity of the output width. This value specifies the increments that are valid between MinFrameSize and
        ///     MaxFrameSize. Read-only.
        /// </summary>
        public int FrameSizeGranularityX;

        /// <summary>
        ///     Granularity of the output height. This value specifies the increments that are valid between MinFrameSize and
        ///     MaxFrameSize. Read-only.
        /// </summary>
        ...
        /// <summary>
        ///     Native size of the incoming video signal. This is the largest signal the filter can digitize with every pixel
        ///     remaining unique. Read-only.
        /// </summary>
        ...
        internal VideoCapabilities(IAMStreamConfig videoStreamConfig)
        {
            ...
            var pCaps = IntPtr.Zero;
            IntPtr pMediaType;
            try
            {
                // Ensure this device reports capabilities
                int c, size;
                var hr = videoStreamConfig.GetNumberOfCapabilities(out c, out size);
